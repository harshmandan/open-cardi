<script lang="ts">
	...
	const OVERALL_GLOWS: GlowDef[] = [
		...
		{
			d: 'M826 1112L899 1057H1235L1189 1213L1167 1238.5L1157.5 1264.5L1117.5 1253.5L780.5 1235.5L826 1112Z',
			sourceZone: 'floor',
			kind: 'fill'
		},
		// passenger footwell pool
		{
			d: 'M1566.5 1213L1527.5 1027L1901.5 1016.5V1094L1943.5 1143.5V1234.5L1767 1240.5L1595 1257L1566.5 1213Z',
			sourceZone: 'floor',
			kind: 'fill'
		}
	];
	...
	const PAGE_VISUALS: Partial<Record<ZoneId, PageVisual>> = {
		...
		doors: {
			...
			glows: [
				...
				{
					d: 'M2218.5 1520L2189 1193L1545.5 1108.5L1481.5 1520L2218.5 1520Z',
					sourceZone: 'floor',
					kind: 'fill'
				}
			]
		...
		skylight: {
			...
			glows: [
				...
				{
					d: 'M446 281.5L964.5 613.5H1787.5L2303.5 285M2552.5 132L2755.5 3.5M202 134L-1.5 8',
					sourceZone: 'skylight'
				}
			]
		},
